...
QT_MOC_LITERAL(7, 63, 12), // "getSteigrate"
QT_MOC_LITERAL(8, 76, 7), // "getRoll"
QT_MOC_LITERAL(9, 84, 11), // "getAltitude"
QT_MOC_LITERAL(10, 96, 11) // "getPressure"

    },
    "MyGlobalObject\0test\0\0text\0getLatitude\0"
    "getLongitude\0getAirspeed\0getSteigrate\0"
    "getRoll\0getAltitude\0getPressure"
};
...
void MyGlobalObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: { double _r = _t->getSteigrate();
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = std::move(_r); }  break;
        case 5: { double _r = _t->getRoll();
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = std::move(_r); }  break;
        case 6: { double _r = _t->getAltitude();
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = std::move(_r); }  break;
        case 7: { double _r = _t->getPressure();
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
