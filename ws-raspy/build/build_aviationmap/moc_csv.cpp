...
QT_MOC_LITERAL(1, 4, 11), // "getLatitude"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 12), // "getLongitude"
QT_MOC_LITERAL(4, 30, 11), // "getAirspeed"
QT_MOC_LITERAL(5, 42, 12), // "getSteigrate"
QT_MOC_LITERAL(6, 55, 7), // "getRoll"
QT_MOC_LITERAL(7, 63, 11), // "getAltitude"
QT_MOC_LITERAL(8, 75, 11) // "getPressure"

    },
    "CSV\0getLatitude\0\0getLongitude\0getAirspeed\0"
...
void CSV::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { qreal _r = _t->getLatitude();
            if (_a[0]) *reinterpret_cast< qreal*>(_a[0]) = std::move(_r); }  break;
        case 1: { qreal _r = _t->getLongitude();
            if (_a[0]) *reinterpret_cast< qreal*>(_a[0]) = std::move(_r); }  break;
        case 2: { double _r = _t->getAirspeed();
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = std::move(_r); }  break;
        case 3: { double _r = _t->getSteigrate();
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = std::move(_r); }  break;
        case 4: { double _r = _t->getRoll();
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = std::move(_r); }  break;
        case 5: { double _r = _t->getAltitude();
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = std::move(_r); }  break;
        case 6: { double _r = _t->getPressure();
            if (_a[0]) *reinterpret_cast< double*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
